 ...
 */
async function convertTSLintConfig(rawTSLintJson, tslintJsonPath, ignoreExtendsVals) {
    const convertedProject = await (0, convert_to_eslint_config_1.convertToESLintConfig)(tslintJsonPath, rawTSLintJson, ignoreExtendsVals);
