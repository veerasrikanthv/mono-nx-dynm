 ...
 */
async function convertToESLintConfig(pathToTslintJson, tslintJson, ignoreExtendsVals) {
    /**
    ...
    const reportedConfiguration = await findReportedConfiguration(`${pm.exec} tslint --print-config`, pathToTslintJson);
