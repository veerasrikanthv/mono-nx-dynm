...
class ProjectConverter {
     ...
     */
    async convertRootTSLintConfig(applyPackageSpecificModifications, rootEslintConfigExists) {
        ...
        const convertedRoot = await (0, utils_1.convertTSLintConfig)(this.rootTSLintJson, this.rootTSLintJsonPath, []);
    ...
    async convertProjectConfig(applyPackageSpecificModifications) {
        if (this.ignoreExistingTslintConfig || !this.projectTSLintJson) {
            return Promise.resolve(() => { });
        }
        const convertedProjectConfig = await (0, utils_1.convertTSLintConfig)(this.projectTSLintJson, this.projectTSLintJsonPath, 
